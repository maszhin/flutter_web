...
enum BoxShape {
  ...
  /// [BorderRadius]). The edges of the rectangle will match the edges of the
  /// box into which the [Border] or [BoxDecoration] is painted.
  ///
  /// See also:
  ///
...
///  * [BorderSide], which is used to describe each side of the box.
///  * [Theme], from the material layer, which can be queried to obtain
///    appropriate colors to use for borders in a material app, as shown in the
///    "divider" sample above.
