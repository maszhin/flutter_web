...
class BouncingScrollSimulation extends Simulation {
  ...
  /// The maximum velocity that can be transferred from the inertia of a
  /// ballistic scroll into overscroll.
  static const double maxSpringTransferVelocity = 5000.0;

  /// When [x] falls below this value the simulation switches from an internal
  /// friction model to a spring model which causes [x] to "spring" back to
  /// [leadingExtent].
  final double leadingExtent;

  /// When [x] exceeds this value the simulation switches from an internal
  /// friction model to a spring model which causes [x] to "spring" back to
  /// [trailingExtent].
  final double trailingExtent;

  /// The spring used used to return [x] to either [leadingExtent] or
  /// [trailingExtent].
...
class ClampingScrollSimulation extends Simulation {
  ...
  // produced for an initial velocity of 4000. The value of
  // Scroller.getDuration() and Scroller.getFinalY() were 686ms and 961 pixels
  // respectively.
  //
