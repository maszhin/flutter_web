      ...
      child: SizedBox(
        ...
        child: SingleChildScrollView(
          ...
          child: ListBody(
            ...
            children: <Widget>[
              Container(
                  key: const ValueKey<int>(0), width: 200.0, height: 200.0),
              Container(
                  key: const ValueKey<int>(1), width: 200.0, height: 200.0),
              Container(
                  key: const ValueKey<int>(2), width: 200.0, height: 200.0),
              Container(
                  key: const ValueKey<int>(3), width: 200.0, height: 200.0),
              Container(
                  key: const ValueKey<int>(4), width: 200.0, height: 200.0),
              Container(
                  key: const ValueKey<int>(5), width: 200.0, height: 200.0),
              Container(
                  key: const ValueKey<int>(6), width: 200.0, height: 200.0),
            ],
          ),
        ),
      ),
                    ...
                    slivers: <Widget>[
                      ...
                      SliverToBoxAdapter(
                          child: Container(
                              ...
                              width: 200.0,
                              height: 200.0),
                          key: const ValueKey<String>('center')),
                      SliverToBoxAdapter(
                          child: Container(
                              key: const ValueKey<int>(1),
                              width: 200.0,
