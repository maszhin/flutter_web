...
class TestRoute extends Route<String> with LocalHistoryRoute<String> {
  ...
  void install(OverlayEntry insertionPoint) {
    ...
    final OverlayEntry entry = OverlayEntry(
        builder: (BuildContext context) => Container(), opaque: true);
    _entries.add(entry);
  ...
  void dispose() {
    log('dispose');
    for (OverlayEntry entry in _entries) entry.remove();
    _entries.clear();
    routes.remove(this);
    super.dispose();
  }
...
Future<void> runNavigatorTest(WidgetTester tester, NavigatorState host,
    VoidCallback test, List<String> expectations) async {
...
void main() {
  ...
  testWidgets('Route management - push, replace, pop',
  ...
  testWidgets('Route management - push, remove, pop',
    ...
    await tester.pumpWidget(
      Directionality(
        textDirection: TextDirection.ltr,
        child: Navigator(
            key: navigatorKey, onGenerateRoute: (_) => TestRoute('first')),
      ),
    );
    final NavigatorState host = navigatorKey.currentState;
    await runNavigatorTest(tester, host, () {}, <String>[
  ...
  testWidgets('Route management - push, replace, popUntil',
    ...
    await tester.pumpWidget(
      Directionality(
        textDirection: TextDirection.ltr,
        child: Navigator(
            key: navigatorKey, onGenerateRoute: (_) => TestRoute('A')),
      ),
    );
    final NavigatorState host = navigatorKey.currentState;
    await runNavigatorTest(tester, host, () {}, <String>[
  ...
  testWidgets('Route localHistory - popUntil', (WidgetTester tester) async {
    ...
    routeA.addLocalHistoryEntry(LocalHistoryEntry(onRemove: () {
