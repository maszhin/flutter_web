...
void main() {
  ...
  testWidgets('RenderObjectWidget can add and remove children',
    ...
    await tester.pumpWidget(DecoratedBox(
        ...
        child: TestWidget(
            child:
                TestWidget(child: DecoratedBox(decoration: kBoxDecorationB)))));
  ...
  testWidgets('Can watch inherited widgets', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(MediaQuery(
        data: const MediaQueryData(size: Size(400.0, 300.0)), child: box));
    ...
    await tester.pumpWidget(MediaQuery(
        data: const MediaQueryData(size: Size(300.0, 400.0)), child: box));
