...
void main() {
  group(Stack, () {
    testWidgets('stacks its children', (WidgetTester tester) async {
  ...
  testWidgets('Can remove parent data', (WidgetTester tester) async {
    ...
    final Container container =
        new Container(key: key, width: 10.0, height: 10.0);
  ...
  testWidgets('Can align non-positioned children (LTR)',
    ...
    final StackParentData child0RenderObjectParentData =
        child0.renderObject.parentData;
    ...
    final StackParentData child1RenderObjectParentData =
        child1.renderObject.parentData;
  ...
  testWidgets('Can construct an IndexedStack', (WidgetTester tester) async {
    ...
    // TODO(ferhat): enable once painters are invoked.
  ...
  testWidgets('Alignment with partially-positioned children',
      ...
      new Directionality(
        ...
        child: new Stack(
          ...
          children: const <Widget>[
            ...
            const Positioned(
                left: 0.0, child: const SizedBox(width: 100.0, height: 100.0)),
            const Positioned(
                right: 0.0, child: const SizedBox(width: 100.0, height: 100.0)),
            const Positioned(
                top: 0.0, child: const SizedBox(width: 100.0, height: 100.0)),
            const Positioned(
                bottom: 0.0,
                child: const SizedBox(width: 100.0, height: 100.0)),
            const PositionedDirectional(
                start: 0.0, child: const SizedBox(width: 100.0, height: 100.0)),
            const PositionedDirectional(
                end: 0.0, child: const SizedBox(width: 100.0, height: 100.0)),
            const PositionedDirectional(
                top: 0.0, child: const SizedBox(width: 100.0, height: 100.0)),
            const PositionedDirectional(
                bottom: 0.0,
    ...
    expect(tester.getRect(find.byType(SizedBox).at(0)),
        new Rect.fromLTWH(350.0, 250.0, 100.0, 100.0));
    expect(tester.getRect(find.byType(SizedBox).at(1)),
        new Rect.fromLTWH(0.0, 250.0, 100.0, 100.0));
    expect(tester.getRect(find.byType(SizedBox).at(2)),
        new Rect.fromLTWH(700.0, 250.0, 100.0, 100.0));
    expect(tester.getRect(find.byType(SizedBox).at(3)),
        new Rect.fromLTWH(350.0, 0.0, 100.0, 100.0));
    expect(tester.getRect(find.byType(SizedBox).at(4)),
        new Rect.fromLTWH(350.0, 500.0, 100.0, 100.0));
    ...
    expect(tester.getRect(find.byType(SizedBox).at(0)),
        new Rect.fromLTWH(700.0, 500.0, 100.0, 100.0));
    expect(tester.getRect(find.byType(SizedBox).at(1)),
        new Rect.fromLTWH(0.0, 500.0, 100.0, 100.0));
    expect(tester.getRect(find.byType(SizedBox).at(2)),
        new Rect.fromLTWH(700.0, 500.0, 100.0, 100.0));
    expect(tester.getRect(find.byType(SizedBox).at(3)),
        new Rect.fromLTWH(700.0, 0.0, 100.0, 100.0));
    expect(tester.getRect(find.byType(SizedBox).at(4)),
        new Rect.fromLTWH(700.0, 500.0, 100.0, 100.0));
    expect(tester.getRect(find.byType(SizedBox).at(5)),
        new Rect.fromLTWH(0.0, 500.0, 100.0, 100.0));
