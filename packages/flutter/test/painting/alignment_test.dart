...
void main() {
  ...
  test('AlignmentGeometry.resolve()', () {
    ...
    expect(const AlignmentDirectional(0.5, -0.3).resolve(TextDirection.rtl),
        const Alignment(-0.5, -0.3));
    expect(const AlignmentDirectional(0.0, 0.0).resolve(TextDirection.ltr),
        const Alignment(0.0, 0.0));
    expect(const AlignmentDirectional(0.0, 0.0).resolve(TextDirection.rtl),
        const Alignment(0.0, 0.0));
    expect(const AlignmentDirectional(1.0, 1.0).resolve(TextDirection.ltr),
        const Alignment(1.0, 1.0));
    expect(const AlignmentDirectional(1.0, 1.0).resolve(TextDirection.rtl),
        const Alignment(-1.0, 1.0));
    ...
    for (TextDirection direction in TextDirection.values) {
      ...
      expect(
          Alignment.center
              .add(const AlignmentDirectional(1.0, 2.0) % 2.0)
              .resolve(direction),
          const AlignmentDirectional(1.0, 0.0).resolve(direction));
      expect(
          Alignment.center
              .add(const AlignmentDirectional(1.0, 2.0) ~/ 2.0)
              .resolve(direction),
          const AlignmentDirectional(0.0, 1.0).resolve(direction));
    }
  ...
  test('AlignmentGeometry toString', () {
    ...
    expect(
        const Alignment(-1.0, 1.0)
            .add(const AlignmentDirectional(1.0, 0.0))
            .toString(),
        'bottomLeft + AlignmentDirectional.centerEnd');
    expect(const Alignment(0.0001, 0.0001).toString(), 'Alignment(0.0, 0.0)');
    expect(const Alignment(0.0, 0.0).toString(), 'center');
    expect(const AlignmentDirectional(0.0, 0.0).toString(),
        'AlignmentDirectional.center');
    expect(
        const Alignment(1.0, 1.0)
            .add(const AlignmentDirectional(1.0, 1.0))
            .toString(),
