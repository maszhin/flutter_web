...
void main() {
  ...
  test('TextTheme merges properly in the presence of null fields.', () {
    const TextTheme partialTheme =
        TextTheme(title: TextStyle(color: Color(0xcafefeed)));
  ...
  test('TextTheme apply', () {
    ...
    final TextDecoration decoration = TextDecoration.combine(
  ...
  test('TextTheme apply fontSizeFactor fontSizeDelta', () {
    ...
    final TextTheme baseTheme =
        Typography.englishLike2014.merge(typography.black);
    ...
    expect(
        sizeTheme.display4.fontSize, baseTheme.display4.fontSize * 2.0 + 5.0);
    expect(
        sizeTheme.display3.fontSize, baseTheme.display3.fontSize * 2.0 + 5.0);
    expect(
        sizeTheme.display2.fontSize, baseTheme.display2.fontSize * 2.0 + 5.0);
    expect(
        sizeTheme.display1.fontSize, baseTheme.display1.fontSize * 2.0 + 5.0);
    expect(sizeTheme.caption.fontSize, baseTheme.caption.fontSize * 2.0 + 5.0);
    expect(
        sizeTheme.headline.fontSize, baseTheme.headline.fontSize * 2.0 + 5.0);
    ...
    expect(
        sizeTheme.subtitle.fontSize, baseTheme.subtitle.fontSize * 2.0 + 5.0);
    expect(
        sizeTheme.overline.fontSize, baseTheme.overline.fontSize * 2.0 + 5.0);
  });
}
