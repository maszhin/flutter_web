...
import 'package:flutter_web_ui/ui.dart' show window, Clip;
...
Finder findRenderChipElement() {
  return find.byElementPredicate(
      (Element e) => '${e.runtimeType}' == '_RenderChipElement');
}
...
double getSelectProgress(WidgetTester tester) =>
    getRenderChip(tester)?.checkmarkAnimation?.value;
double getAvatarDrawerProgress(WidgetTester tester) =>
    getRenderChip(tester)?.avatarDrawerAnimation?.value;
double getDeleteDrawerProgress(WidgetTester tester) =>
    getRenderChip(tester)?.deleteDrawerAnimation?.value;
double getEnableProgress(WidgetTester tester) =>
    getRenderChip(tester)?.enableAnimation?.value;
...
void main() {
  ...
  testWidgets('Delete button drawer works as expected on RawChip',
    ...
    expect(tester.getSize(find.byKey(deleteButtonKey)),
        equals(const Size(24.0, 24.0)));
    expect(
        tester.getTopLeft(find.byKey(deleteButtonKey)).dx, closeTo(53.2, 0.1));
    expect(tester.getTopLeft(find.byKey(labelKey)),
        equals(const Offset(12.0, 17.0)));
    ...
    expect(tester.getSize(find.byKey(deleteButtonKey)),
        equals(const Size(24.0, 24.0)));
    expect(
        tester.getTopLeft(find.byKey(deleteButtonKey)).dx, closeTo(58.7, 0.1));
    ...
    expect(tester.getSize(find.byKey(deleteButtonKey)),
        equals(const Size(24.0, 24.0)));
    expect(
        tester.getTopLeft(find.byKey(deleteButtonKey)).dx, closeTo(66.7, 0.1));
    ...
    expect(tester.getSize(find.byKey(deleteButtonKey)),
        equals(const Size(24.0, 24.0)));
    expect(
        tester.getTopLeft(find.byKey(deleteButtonKey)).dx, closeTo(71.5, 0.1));
    ...
    expect(tester.getSize(find.byKey(deleteButtonKey)),
        equals(const Size(24.0, 24.0)));
    expect(
        tester.getTopLeft(find.byKey(deleteButtonKey)).dx, closeTo(75.8, 0.1));
    expect(tester.getTopLeft(find.byKey(labelKey)),
        equals(const Offset(12.0, 17.0)));
    ...
    expect(tester.getSize(find.byKey(deleteButtonKey)),
        equals(const Size(24.0, 24.0)));
    expect(
        tester.getTopLeft(find.byKey(deleteButtonKey)).dx, closeTo(74.9, 0.1));
    ...
    expect(tester.getSize(find.byKey(deleteButtonKey)),
        equals(const Size(24.0, 24.0)));
    expect(
        tester.getTopLeft(find.byKey(deleteButtonKey)).dx, closeTo(73.0, 0.1));
    ...
    expect(tester.getSize(find.byKey(deleteButtonKey)),
        equals(const Size(24.0, 24.0)));
    expect(
        tester.getTopLeft(find.byKey(deleteButtonKey)).dx, closeTo(69.5, 0.1));
  ...
  testWidgets('Chip elevation works correctly', (WidgetTester tester) async {
    ...
    InputChip inputChip =
        const InputChip(label: Text('Label'), pressElevation: 8.0);
