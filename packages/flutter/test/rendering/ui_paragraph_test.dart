...
import 'package:flutter_web_ui/ui.dart' as ui show TextBox;
...
void main() {
  ...
  test('overflow test', () {
    ...
    relayoutWith(
        maxLines: null, softWrap: false, overflow: TextOverflow.ellipsis);
    expect(paragraph.size.height, equals(2 * lineHeight));
    ...
    expect(paragraph.debugHasOverflowShader, isFalse);
  }, skip: 'maxLines not implemented yet');
  ...
  test('nested TextSpans in paragraph handle textScaleFactor correctly.', () {
    ...
    final RenderParagraph paragraph = RenderParagraph(testSpan,
        textDirection: TextDirection.ltr, textScaleFactor: 1.3);
