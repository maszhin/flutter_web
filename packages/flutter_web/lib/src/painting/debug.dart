...
///
/// This is useful when writing golden file tests (see [matchesGoldenFile])
/// since the rendering of shadows is not guaranteed to be pixel-for-pixel
/// identical from version to version (or even from run to run).
bool debugDisableShadows = false;

/// Returns true if none of the painting library debug variables have been
/// changed.
///
