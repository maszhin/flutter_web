...
/// [new BorderRadius.only] and its variants, or
/// [new BorderRadiusDirectional.only] and its variants.
///
...
abstract class BorderRadiusGeometry {
  ...
  ///
  /// If [subtract] is applied to two objects of the same type ([BorderRadius]
  /// or [BorderRadiusDirectional]), an object of that type will be returned
  /// (though this is not reflected in the type system). Otherwise, an object
  ...
  ///
  /// If you know you are adding two [BorderRadius] or two
  /// [BorderRadiusDirectional] objects, consider using the `+` operator
  ...
  /// [BorderRadiusDirectional]), an object of that type will be returned
  /// (though this is not reflected in the type system). Otherwise, an object
  /// representing a combination of both is returned. That object can be turned
  /// into a concrete [BorderRadius] using [resolve].
  ...
  /// Integer divides the [BorderRadiusGeometry] object's corners by the given
  /// factor.
  ///
  /// This operator returns an object of the same type as the operand.
  ///
  ...
  /// and the result is an object of the same type as the non-null argument.
