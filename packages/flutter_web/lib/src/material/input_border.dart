...
abstract class InputBorder extends ShapeBorder {
  ...
  // TODO(het): assert(borderSide != null) once we fix
  ...
  ///
  /// The additional `gap` parameters reflect the state of the
  /// [InputDecorator]'s floating label. When an input decorator gains the
  /// focus, its label animates upwards, to make room for the input child. The
  /// [gapStart] and [gapExtent] parameters define a floating label width
  /// interval, and [gapPercentage] defines the animation's progress
  /// (0.0 to 1.0).
  @override
  void paint(
    Canvas canvas,
