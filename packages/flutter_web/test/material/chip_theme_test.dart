...
import 'package:flutter_ui/ui.dart' show window;
...
void main() {
  ...
  testWidgets('Chip uses ThemeData chip theme if present',
    ...
    expect(materialBox,
        paints..path(color: Color(chipTheme.backgroundColor.value)));
  });

  testWidgets('Chip overrides ThemeData theme if ChipTheme present',
      (WidgetTester tester) async {
    final ThemeData theme = ThemeData(
      platform: TargetPlatform.android,
      primarySwatch: Colors.red,
    ...
    expect(materialBox,
        paints..path(color: Color(customTheme.backgroundColor.value)));
  });
  ...
  testWidgets('ChipThemeData generates correct opacities for defaults',
    ...
    expect(lightTheme.labelPadding,
    ...
    expect(customTheme.labelPadding,
        equals(const EdgeInsets.symmetric(horizontal: 8.0)));
  ...
  testWidgets('ChipThemeData lerps correctly', (WidgetTester tester) async {
    ...
    expect(
        ...
        equals(const EdgeInsets.only(
            left: 0.0, top: 6.0, right: 0.0, bottom: 6.0)));
