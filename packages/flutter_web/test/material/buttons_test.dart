...
void main() {
  ...
  testWidgets('Does FlatButton contribute semantics',
    ...
    await tester.pumpWidget(
      Directionality(
        ...
        child: Material(
          child: Center(
            child: FlatButton(onPressed: () {}, child: const Text('ABC')),
          ),
        ),
      ),
    );
  ...
  testWidgets('Does RaisedButton contribute semantics',
    ...
    await tester.pumpWidget(
      Directionality(
        ...
        child: Material(
          child: Center(
            child: RaisedButton(onPressed: () {}, child: const Text('ABC')),
          ),
        ),
      ),
    );
  ...
  testWidgets('Does FlatButton scale with font scale changes',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      Directionality(
        textDirection: TextDirection.ltr,
  ...
  testWidgets('Disabled MaterialButton has correct default text color',
      (WidgetTester tester) async {
  ...
  testWidgets('RaisedButton has no clip by default',
    ...
    expect(tester.renderObject(find.byType(RaisedButton)),
        paintsExactlyCountTimes(#clipPath, 0));
  });
}
