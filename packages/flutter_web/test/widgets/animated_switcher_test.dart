...
void main() {
  testWidgets('AnimatedSwitcher fades in a new child.',
    ...
    await tester.pumpWidget(
      new AnimatedSwitcher(
        duration: const Duration(milliseconds: 100),
        child:
            new Container(key: containerThree, color: const Color(0xffff0000)),
        switchInCurve: Curves.linear,
        switchOutCurve: Curves.linear,
      ),
    );
  ...
  testWidgets('AnimatedSwitcher uses custom transitions.',
    ...
    for (Widget child in foundChildren) {
      expect(child, test.TypeMatcher<KeyedSubtree>());
    }
  ...
  testWidgets(
    ...
    await tester.pumpWidget(
      new AnimatedSwitcher(
        duration: const Duration(milliseconds: 100),
        child:
            new Container(key: containerThree, color: const Color(0xFF0000FF)),
        switchInCurve: Curves.linear,
        switchOutCurve: Curves.linear,
        layoutBuilder: newLayoutBuilder,
      ),
