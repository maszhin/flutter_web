...
[![Gitter chat](https://badges.gitter.im/flutter/flutter.png)](https://gitter.im/flutter/flutter)

Welcome to the code repository for [Flutter for web](https://flutter.dev/web).

For quick answers check out our [FAQ](https://github.com/flutter/flutter/blob/master/docs/faq.md).
...
* `flutter` does not have a plugin system yet. _Temporarily_, we provide
...
* At this time, desktop UI interactions are not fully complete, so a UI built
  with `flutter` may feel like a mobile app, even
...
[issue tracker]: https://goo.gle/flutter_issue
...
`flutter` preview make sure you have upgraded Flutter to at least `v1.5.4`
...
### Clone the flutter source code

Clone this repository locally.

### Install the flutter build tools
...
### Use flutter packages from git

If you'd like to depend on the `flutter` packages without cloning the
...
[the migration guide](https://github.com/flutter/flutter/blob/master/docs/migration_guide.md).
